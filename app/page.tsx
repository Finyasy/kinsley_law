...
function splitRotatorPrefix(prefix: string) {
  ...
  if (!trimmed) {
    return { primaryText: "Strategic attorney", staticText: "with" };
  }
...
export const metadata: Metadata = {
  title: "Strategic Attorney for High-Stakes Matters",
  description:
    "Kinsley Advocates delivers strategic, attorney-led legal services for private clients, businesses, property matters, disputes, and mineral-sector work in Nairobi.",
};
      ...
      <section className="hero-shell">
        <div className="site-container hero-grid">
          <div className="hero-copy">
            ...
            />
            <p className="hero-kicker">Strategic attorney-led legal services for matters that need calm control.</p>
