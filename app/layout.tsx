...
export const metadata: Metadata = {
  ...
  description:
    "Kinsley Advocates delivers dignified, strategic attorney-led legal services for private clients, families, founders, investors, and businesses in Nairobi.",
  ...
  openGraph: {
    ...
    description:
      "Strategic attorney-led legal services for private clients, businesses, investors, disputes, and mineral-sector matters in Nairobi.",
    images: [
      {
